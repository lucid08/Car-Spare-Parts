...
import { createProduct, deleteProduct, getProductById, getProducts, getProductsByCategory, getProductsByCategoryForHome, hii, updateProduct } from '../controllers/product.controller.js';
...
router.route('/update-product/:id').put(verifyToken, updateProduct); // Apply middleware her
